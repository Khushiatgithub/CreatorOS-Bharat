        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-white/[0.08] pb-5">
          ...
          <div className="flex items-center gap-3">
            {products.length > 0 && (
              ...
              >
                <CreditCard className="h-4 w-4 text-royal-400" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {products.map((prod) => (
            ...
            >
              <div>
                {/* Cover image & badges */}
                <div className="relative h-40 w-full rounded-[16px] overflow-hidden mb-4 bg-black/40">
              ...
              <div className="mt-5 pt-3 border-t border-white/[0.08] space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-baseline gap-2">
                      <span className="font-display text-lg font-bold text-white">₹{prod.price}</span>
                      {prod.originalPrice && (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 rounded-[12px] bg-royal-600/20 hover:bg-royal-600/35 border border-royal-500/35 py-2 text-xs font-semibold text-royal-300 hover:text-white transition btn-press"
                >
                  <Zap className="h-3.5 w-3.5 text-royal-400 fill-royal-400" />
                  <span>Test Razorpay Checkout (₹{prod.price})</span>
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xl overflow-y-auto">
            <div className="relative w-full max-w-lg rounded-[24px] border border-white/[0.12] bg-[#0A0D17] p-6 shadow-2xl text-slate-100 animate-scale-in my-8">
              ...
              <form onSubmit={handleCreateProduct} className="space-y-3.5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-[14px] border border-white/[0.1] bg-black/40 px-3 py-2 text-xs text-white focus:border-royal-500 focus:outline-none"
                    >
                      <option value="Notes & Sheets">Notes & Sheets</option>
                      <option value="Resume & Career">Resume & Career</option>
                ...
                <div>
                  <label className="block text-xs font-medium text-slate-300 mb-1">Download Asset Link</label>
                  <input
                    type="url"
                    required
                    value={downloadUrl}
                ...
                <div className="pt-2">
                  <RippleButton
                    type="submit"
                    className="w-full rounded-[16px] bg-royal-600 hover:bg-royal-500 py-3 text-xs font-bold text-white shadow-royal"
                  >
