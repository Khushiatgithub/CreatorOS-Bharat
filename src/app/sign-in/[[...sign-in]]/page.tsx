...
import { Zap, ShieldCheck, ArrowLeft, Mail, Lock, ArrowRight, AlertCircle, Sparkles } from 'lucide-react';
...
function ClerkSignInForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Open native styled Google Account Chooser popup
      setGoogleModalOpen(true);
    }
  };
  ...
  return (
    <>
      <div className="w-full rounded-[24px] border border-white/[0.12] bg-[#0A0D17]/95 p-7 shadow-2xl backdrop-blur-xl space-y-5 animate-scale-in">
        ...
        {/* Google OAuth Option - Directly opens native Google Account Chooser */}
        <button
          type="button"
...
function StandardSignInForm() {
  ...
  const handleGoogleSignIn = () => {
    // Directly opens Google's native account chooser window/modal
    setGoogleModalOpen(true);
  };
...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#05070B] text-slate-100 flex flex-col justify-center items-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="absolute bottom-10 right-10 w-[300px] h-[300px] bg-royal-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="mb-6 text-center space-y-2 z-10">
        ...
        <p className="text-xs text-slate-400 max-w-sm mx-auto">
          Access your digital storefront, course analytics, and UPI payouts.
        </p>
      </div>

      {/* Main Authentication Card */}
      <div className="z-10 w-full max-w-md flex justify-center">
        {isClerk ? <ClerkSignInForm /> : <StandardSignInForm />}
      </div>
