    ...
    <div className="w-full rounded-[24px] border border-white/[0.12] bg-[#0A0D17]/95 p-7 shadow-2xl backdrop-blur-xl space-y-5 animate-scale-in">
      ...
      <div className="pt-2 border-t border-white/[0.08] text-center">
        <button
          ...
          className="w-full flex items-center justify-center gap-2 rounded-[12px] bg-royal-600/15 border border-royal-500/30 px-3 py-2 text-xs font-semibold text-royal-300 hover:bg-royal-600/25 transition btn-press"
        >
          <Sparkles className="h-3.5 w-3.5 text-royal-400" />
          <span>1-Click Instant Studio Access</span>
        </button>
      </div>
