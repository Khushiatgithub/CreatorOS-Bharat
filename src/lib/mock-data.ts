...
export const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    creatorId: 'creator_aarav',
    buyerName: 'Zepto Tech Ventures Pvt Ltd',
    buyerEmail: 'accounts@zeptonow.com',
    buyerPhone: '+91 91234 56780',
    buyerState: 'Maharashtra',
    buyerGst: '27AABCZ1234F1Z9',
    itemType: 'product',
    itemId: 'custom_brand_sponsorship',
    itemTitle: 'Q1 Tech Newsletter & YouTube Dedicated Brand Integration',
    amount: 35000,
    gstRate: 18,
    cgst: 0,
    sgst: 0,
    ...
    invoiceNumber: 'INV-2025-00104',
    sacCode: '998311',
    status: 'pending',
    paymentStatus: 'Pending',
    notes: 'Net-15 payment terms. Payable via RTGS/NEFT or Corporate Netbanking.',
    deliverySentWhatsapp: false,
    deliverySentEmail: true
  },
  {
    id: 'ord_105',
    ...
    dueDate: new Date(Date.now() - 3600000 * 24 * 2).toISOString(),
    creatorId: 'creator_aarav',
    buyerName: 'Scaler Academy / InterviewBit',
    buyerEmail: 'finance@scaler.com',
    buyerPhone: '+91 98450 11223',
    buyerState: 'Karnataka',
    buyerGst: '29AABCS8899P1ZK',
    itemType: 'booking',
    itemId: 'custom_guest_masterclass',
    itemTitle: 'Distributed Systems & Microservices Live Masterclass (2 Hours)',
    amount: 18000,
    gstRate: 18,
    cgst: 1620,
    sgst: 1620,
    ...
    notes: 'Payment overdue by 2 days. Reminder sent via WhatsApp and Email.',
    deliverySentWhatsapp: true,
    deliverySentEmail: true
  }
];
