...
export const INITIAL_COMMUNITY_POSTS: CommunityPost[] = [
  {
    ...
    authorAvatar: '/avatars/user-avatar.png',
    authorRole: 'creator',
...
export const INITIAL_SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    description: 'High-impact monthly subscription with 1:1 resume tear-downs, weekly live mock interview whiteboarding, system design blueprints, and private VIP community.',
